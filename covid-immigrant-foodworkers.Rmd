...
ipums_food_production_by_county <-
  ...
  summarize(
    total_employment_selected_industries = sum(total_employment_selected_industries),
    ...
    pct_naturalized_citizen_non_hispanic = round(
      naturalized_citizen_non_hispanic / total_employment_selected_industries * 100,
      digits = 0
    ),
...
foodworkers_by_state <- ipums_food_production_by_puma %>%
  group_by(state) %>%
  summarize(
    state_total_employment_selected_industries = sum(total_employment_selected_industries),
    ...
    state_pct_total_foreign_hispanic = round(
      sum(total_foreign_hispanic) / sum(total_employment_selected_industries) * 100
    ),
    2
  ) %>%
  mutate(
